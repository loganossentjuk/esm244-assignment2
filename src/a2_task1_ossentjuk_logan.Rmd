...
ggpairs(palmetto_sub)

p1 <- ggplot(data = palmetto_sub, aes(x = height, y = green_lvs)) + 
...
p2 <- ggplot(data = palmetto_sub, aes (x = width, y = green_lvs)) + 
  geom_boxplot(aes(fill = species, width = 0.2)) + 
   scale_fill_manual(values = c("skyblue", "forestgreen"), 
                    name = "Species") +
  facet_wrap(~species) +
...
p3 <- ggplot(data = palmetto_sub, aes (x = length, y = green_lvs)) + 
  geom_boxplot(aes(fill = species, width = 0.2)) +
  scale_fill_manual(values = c("skyblue","forestgreen"), 
                     name = "Species") +
   facet_wrap(~species) +
